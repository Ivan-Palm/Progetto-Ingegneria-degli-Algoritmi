...
from datastruct.trees.treeArrayList import TALNode as TreeNode
from datastruct.trees.treeArrayList import TreeArrayList as Tree
...
class GraphBase(ABC):
    ...
    def dfsCycle(self, rootId):
        """
        Execute a Depth-First Search (DFS) in the graph starting from the
        specified node and return true  if exist a cycle.
        :param rootId: the root node ID (integer).
        :return: the DFS list of nodes.
        """
        # if the root does not exists, return None
